...
public class ListActivity extends ExpandableListActivity {
    ...
    public void onCreate(final Bundle saved) {
        ...
        // Restore preferences
        mListAdapter.setFilterSystemApps(mPrefs.getBoolean(PREF_FILTER_SYS_APPS, false));
        mListAdapter.setShowChangedOnly(mPrefs.getBoolean(PREF_FILTER_SHOW_CHANGED, false));
        mListAdapter.setFilterUnknown(mPrefs.getBoolean(PREF_FILTER_UNKNOWN, true));
    ...
    protected void updateEmptyText(boolean loadIsFinished) {
        ...
        if (!mListAdapter.isFiltered())
            ...
            full.setSpan(new InternalURLSpan(v ->
