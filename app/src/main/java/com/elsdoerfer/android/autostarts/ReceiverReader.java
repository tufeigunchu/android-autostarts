...
public class ReceiverReader {
    ...
    private final OnLoadProgressListener mOnLoadProgressListener;
     ...
     * Constructor.
     */
    public ReceiverReader(Context context, OnLoadProgressListener progressListener) {
        mContext = context;
        ...
        try {
            ...
            if (packageResourcePath != null) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
                    ...
                    Method findCookieForPath = AssetManager.class.getMethod("findCookieForPath", String.class);
                    int cookie = (int) findCookieForPath.invoke(assets, packageResourcePath);
                ...
                Log.e(ReceiverReader.class.getSimpleName(), "Invalid packageResourcePath for package " + scannedAppContext.getPackageName());
            }
        } catch (Exception e) {
    ...
    void startReceiver() {
        ...
        mCurrentComponent.defaultEnabled = !(Objects.equals(getAttr("enabled"), "false"));
